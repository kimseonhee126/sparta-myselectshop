...
import com.kimseonhee126.myselectshop.repository.UserRepository;
import com.kimseonhee126.myselectshop.service.UserService;
...
import static com.kimseonhee126.myselectshop.service.ProductService.MIN_MY_PRICE;
...
public class TestDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        // 테스트 User 생성
        User testUser = new User("admin", passwordEncoder.encode("1234"), "admin@gmail.com", UserRoleEnum.USER);
